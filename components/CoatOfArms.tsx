...
const CoatOfArms: React.FC<CoatOfArmsProps> = ({ className, imageUrl, isAdmin, onImageUpload }) => {
  ...
  return (
    <div
      ...
      aria-label={isAdmin ? t("Change coat of arms image") : undefined}
    >
      {imageUrl ? (
        <img
          src={imageUrl}
          alt={t("Royal Coat of Arms")}
        ...
        <>
          ...
          >
            <div className="text-center text-white p-4">
              ...
              <p className="mt-1 text-sm font-semibold">{t("Change Image")}</p>
            </div>
          </div>
          <input
            type="file"
